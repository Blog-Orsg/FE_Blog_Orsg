            ...
            <span
              ...
              className={classNames(
                ...
                line.direction === "to left" &&
                  `left-0 h-[5px] w-[calc(var(--size)*1rem)] animate-glow-line-horizontal md:w-[calc(var(--size)*1rem)]`,
                line.direction === "to top" &&
                  `right-0 h-[calc(var(--size)*1rem)] w-[1px] animate-glow-line-vertical md:h-[calc(var(--size)*1rem)]`
              )}
            />
          ))}
        </div>
